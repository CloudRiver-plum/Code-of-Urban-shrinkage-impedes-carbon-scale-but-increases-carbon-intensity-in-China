...
net install ftools, from("C:\Program Files\Stata16\ado\plus\11\ftools-master\src")
 
* Install reghdfe
cap ado uninstall reghdfe
net install reghdfe, from("C:\Program Files\Stata16\ado\plus\11\reghdfe-master\src")

 
* Finally, install this package
cap ado uninstall ivreghdfe
net install ivreghdfe, from("C:\Program Files\Stata16\ado\plus\11\ivreghdfe-master\src")
...
bootstrap r(indirect_effect), reps(1000) seed(123): mediateffect, xvar(SR) mvar(NE) yvar(lnGC)
...
//Result output
outreg2 [m1 m2 m3 m4 m5 m6 m7 m8] using tab13, word replace tstat tdec(2)
